...
# Versão: 2025.11 (Deploy Cloud - Estável)
# =========================================================
...
# ---------------------------------------------------------
# ⚙️ CONFIGURAÇÃO DE PÁGINA (precisa ser o primeiro comando Streamlit)
# ---------------------------------------------------------
...
st.session_state.setdefault("corrections_submitted", False)
st.session_state.setdefault("correcoes_dict", {})
st.session_state.setdefault("correcoes_choices", {})
...
if uploaded_file is not None:
    ...
    if st.session_state["pending_generate"]:
        try:
            ...
            # Verifica combinações faltantes
